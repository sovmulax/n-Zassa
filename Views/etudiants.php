...
<body class="body">
  ...
  <section class="my-main">
    ...
    <div class="my-container">
      <div class="row">
        <div class="col"></div>
        <div class="col l12 m12 s12 my-center">
          <!--Carte des etudiant-->
          <?php foreach ($resultats as $resultat) { ?>
            <div class="my-card">
              <a href="./details/student.php?id=<?php echo $resultat['ID_ETUDIANT'] ?>">
                <img src="../Static/res/etudiant/<?php echo $resultat['PHOTO'] ?>" alt="photo de profil" class="my-card-picture" />
              </a>
              <div class="my-card-text">
                <span class="my-card-title"><?php echo $resultat['NOM'] . ' ' . $resultat['PRENOM'] ?></span>
                <p class="my-text">
                  <?php echo $resultat['MATRICULE'] ?> <br />
                  <?php $req = $connexion->prepare('SELECT * FROM classe WHERE ID_CLASSE = :photo');
                                            $req->execute(['photo' => $resultat['ID_ETUDIANT']]);
                                            $res = $req->fetch();
                                            echo $res['LIBELLECL']; ?> <br />
                </p>
              </div>
            </div>
          <?php } ?>
  ...
  <script>
    ...
    $(document).ready(function() {
      $("#idsearch").on("keyup", function() {
        ...
        $(".my-center .my-card").filter(function() {
